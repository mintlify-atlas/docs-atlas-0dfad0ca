...
description: "How Buzz works under the hood — the relay as single source of truth, Nostr NIP-01 event pipeline, crate dependency hierarchy, and Postgres plus Redis storage layers."
---
