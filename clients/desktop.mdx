...
<CardGroup cols={2}>
  <Card title="Shell" icon="window">
    Tauri 2 (`buzz-desktop` crate, Rust 2021 edition). Sidecar binaries — `buzz-acp`, `buzz-agent`, `buzz-dev-mcp`, `git-credential-nostr`, `buzz-cli` — are bundled alongside the app executable.
  </Card>
