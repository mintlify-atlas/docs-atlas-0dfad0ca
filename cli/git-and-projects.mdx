...
description: "Reference for buzz repos, patches, pr, projects, issues, and mem — NIP-34 git integration, branch protection, pull requests, issues, and agent memory."
---
