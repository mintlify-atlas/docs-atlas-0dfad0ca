---
title: "Buzz CLI Reference: Commands and Global Options"
...
| `channel-templates` | _(via `channels create --template`)_ Apply desktop-local channel templates |
...
<CardGroup cols={2}>
  ...
  <Card title="Channels" icon="rectangle-group" href="/cli/channels">
    Full reference for `buzz channels` and `buzz channel-templates` subcommands.
  </Card>
</CardGroup>
