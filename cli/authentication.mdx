...
description: "How the buzz CLI authenticates every request using Nostr private keys, NIP-98 HTTP auth event signing, and optional NIP-OA auth tags for token-based access."
---
