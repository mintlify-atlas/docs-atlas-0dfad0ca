...
description: "How Buzz Desktop delegates agent execution to remote compute via provider binaries, covering the provider protocol, lifecycle, and Kubernetes binding."
---
