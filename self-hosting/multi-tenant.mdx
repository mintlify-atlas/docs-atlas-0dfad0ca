...
description: "How Buzz isolates multiple communities on one shared Postgres instance using formal non-interference proofs, host-based routing, and community-scoped row labeling."
---
