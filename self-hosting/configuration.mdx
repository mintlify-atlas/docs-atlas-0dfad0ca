...
<ParamField query="BUZZ_AUTO_MIGRATE" type="boolean" default="false">
...
<ParamField query="BUZZ_REQUIRE_RELAY_MEMBERSHIP" type="boolean" default="false">
...
<ParamField query="BUZZ_ALLOW_NIP_OA_AUTH" type="boolean" default="false">
  When `true`, allow NIP-OA (OAuth-style) authentication in addition to NIP-42 Schnorr-signed authentication. Defaults to `false`.
</ParamField>

<ParamField query="RUST_LOG" type="string" default="buzz_relay=debug,buzz_db=debug,buzz_auth=debug,buzz_pubsub=debug,tower_http=debug">
...
<ParamField query="BUZZ_RATE_LIMIT_HUMAN_WS_EVENTS_PER_SEC" type="integer" default="10">
...
<ParamField query="BUZZ_RATE_LIMIT_AGENT_STANDARD_API_CALLS_PER_MIN" type="integer" default="600">
